...
*/
void GaussianModule::run(map<string, Data*>& input, map<string, string> params, map<string, Data*>& output, Context context) const
{
	cout << "GaussianModule has been executed with the following params:";
	cout << endl;
