...
\begin{tikzpicture}
	...
	\node<1-> []  at (4,0.4) {\includegraphics[scale=0.1]{images/wheels}};
...
\begin{frame}{Share the modules}
	...
	\tikzoverlay[] at (1,5.5) {\includegraphics[scale=0.1]{images/smiley}};
	\tikzoverlay[] at (7.5,6) {\includegraphics[scale=0.1]{images/smiley}};
	\tikzoverlay[] at (8.3,2.5) {\includegraphics[scale=0.1]{images/smiley}};
	\tikzoverlay[] at (3,7) {\includegraphics[scale=0.1]{images/smiley}};
...
\begin{frame}{Platform independent}
	\tikzoverlay[] at (0,2.5) {\includegraphics[scale=0.1]{images/linux}};
	\tikzoverlay[] at (8,2.5) {\includegraphics[scale=0.1]{images/mac}};
